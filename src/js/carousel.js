...
let prev = document.querySelector('.carousel__controls .carousel__controls__prev');

let next = document.querySelector('.carousel__controls .carousel__controls__next');
